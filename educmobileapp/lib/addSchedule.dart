...
class _InputScheduleState extends State<InputSchedule> {
  ...
  Future<Album> createSchedule(String day, String timeIn, String timeOut, int subjectId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        bool hasConflict = schedules.any((schedule) {
          ...
          DateTime newTimeIn = DateFormat('hh:mm a').parse(timeIn);
          DateTime newTimeOut = DateFormat('hh:mm a').parse(timeOut);
